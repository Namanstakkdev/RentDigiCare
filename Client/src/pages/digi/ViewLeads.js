  ...
  const getLeads = async (e) => {
    try {
      const response = await axios.get(
        decode.role === "manager" ? GET_MANAGER_LEADS : GET_LEADS
      );
                        ...
                        return (
                          <tbody>
                            <tr>
                              ...
                              {/* <td>{item.email}</td>
                              <td>{item.phone}</td> */}
                              <td>{item.interestedApartment}</td>
                              <td>{item.interestedBedroomType}</td>
                              <td>
                                  {item.propertyName ? item.propertyName : "NA"}
                              </td>
                              <td>
            <select
