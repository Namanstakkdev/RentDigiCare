    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setStats((prev) => ({
          ...
          open: response.data.total?.Open?.count || 0,
          completed: response.data.total?.Completed?.count || 0,
          inprogress: response.data.total?.Inprogress?.count || 0,
          unresolved: response.data.total?.Unresolved?.count || 0,
          timetaken: response.data.total?.TotalTime || 0,
        }));
