  ...
  const uploadDocuments = async (quoteId) => {
    ...
    try {
      const response = await axios.post(
        "/ticket/upload-quoted-documents",
        formData,
        config
      );
    } catch (error) {
      ...
      <div className="page-content">
                        ...
                        <Pagination aria-label="Page navigation example">
                          <PaginationItem disabled={pageNumber == 1}>
                            <PaginationLink
                              onClick={(e) => {
                                e.preventDefault();
                                getVendorPortal(pageNumber - 1, "previous");
                              }}
                              tabIndex="-1"
                            >
                              Previous
                          ...
                          >
                            <PaginationLink
                              onClick={(e) => {
                                e.preventDefault();
                                getVendorPortal(pageNumber + 1, "next");
                              }}
                            >
                              Next
                            </PaginationLink>
        ...
        >
          ...
          <div className="modal-body">
            <Nav
              tabs
              className="nav-tabs-custom nav-justified position-static mb-0"
            >
              <NavItem>
                <NavLink
                  style={{ cursor: "pointer" }}
                  ...
                  <div className="row align-items-center">
                    <div className="col-md-4">
                      <div className="mb-3">
                        ...
                        <Input
                          type="text"
                          value={selectedItem?.companyID?.name}
                          className="form-control"
                    ...
                    <div className="col-md-4">
                      <div className="mb-3">
                        ...
                        <div>
                          <td>
                            <Rating
                              initialValue={selectedItem.ratings}
                              readonly={true}
                              size={20}
                            />
                          </td>
