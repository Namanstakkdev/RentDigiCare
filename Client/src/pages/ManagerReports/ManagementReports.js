                      ...
                      appointment.propertiesData.map(
                        (property, propertyIndex) => {
                          ...
                          return (
                            <tr>
                              {propertyIndex === 0 && (
                                <td rowSpan={appointment.propertiesData.length}>
                              ...
                              {propertyIndex === 0 && (
                                <td
                                  rowSpan={appointment.propertiesData.length}
                                  style={{
                                    verticalAlign: "middle",
                                    textAlign: "center",
                                  }}
                                >
                                  {appointment.managerAvailabilities.length ===
                                  0 ? (
                                    <button
                                    ...
                                    <button
                                      ...
                                      onClick={() => {
                                        handleShowModal();
                                        setAvailability(
                                          appointment.managerAvailabilities[0]
                      ...
                      <tbody>
                        {availabilities.map((availability, index) => (
                          <tr key={index}>
                            ...
                            <td>{availability.available ? "Yes" : "No"}</td>
                            <td>
                              {availability.slots.length > 0 ? (
                                <ul className="list-unstyled">
                                  {availability.slots.map((slot, slotIndex) => (
                                    <li key={slotIndex}>
                                      {convertToLocalTime(slot.startTime)} -{" "}
                                      {convertToLocalTime(slot.endTime)}
                                    </li>
                                  ))}
                                </ul>
                              ) : (
                ...
                <Table className="table table-striped table-bordered mb-0">
                  ...
                  <tbody>
                    {tickets.map((ticket, index) =>
                      ticket.properties.map((property, propertyIndex) => (
                        <tr>
                          {propertyIndex === 0 && (
                            ...
                            (assignedToType, assignTypeIndex) => (
                              <td>
                                {property.assignedToTypes.find(
                                  (count) =>
                                    count.assignedToType === assignedToType
                                )?.count || 0}
                              </td>
                            )
                          )}
                    ...
                    <tr>
                      ...
                      <td>
                        {tickets.reduce((total, ticket) => {
                          return (
                            total +
                            ticket.properties.reduce((acc, property) => {
            ...
            <Accordion.Body>
              <div className="table-responsive">
                <Table className="table table-striped table-bordered mb-0">
                  ...
                  <tbody>
                    {technicalStaffReports.map((technicalStaffReport, index) =>
                      technicalStaffReport.properties.map(
                        (property, propertyIndex) => (
                          <tr>
                            {propertyIndex === 0 && (
                              <td
                                rowSpan={technicalStaffReport.properties.length}
                              >
                                {propertyIndex === 0 ? index + 1 : null}
                              </td>
                            )}
                ...
                <Table className="table table-striped table-bordered mb-0">
                  ...
                  <tbody>
                    {applicants.map((applicant, index) =>
                      applicant.properties.map((property, propertyIndex) => (
                        <tr>
                          {propertyIndex === 0 && (
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        {applicants.reduce((total, applicant) => {
                          return (
                            total +
                            applicant.properties.reduce((acc, property) => {
