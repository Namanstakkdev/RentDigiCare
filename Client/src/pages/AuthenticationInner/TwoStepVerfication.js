...
const TwoStepVerfication = (props) => {
    ...
    const VERIFY_OTP = "/forget_password/verify-otp"
    ...
    const handleConfirm = async (e) => {
        ...
        try {
            setLoading(true)
            const response = await axios.post(VERIFY_OTP, { email: email, otp: code });
            if (response.data.status == 200) {
                console.log("Temp:", response.data.message)
                setForgetSuccessMsg(response.data.message)
                history.push("/comfirm-password", { email: email })
                                        ...
                                        <div className="auth-content my-auto">
                                            <div className="text-center">
                                                ...
                                                <div className="p-2 mt-4">
                                                    ...
                                                    <p className="mb-5">Please enter the 4 digit code sent to <span className="fw-bold">{email}</span></p>
                                                    ...
                                                    <div className="mt-4">
                                                        {loading ?
                                                            ...
                                                            <button onClick={(e) => { handleConfirm(e) }} className="btn btn-primary w-100">Confirm</button>
