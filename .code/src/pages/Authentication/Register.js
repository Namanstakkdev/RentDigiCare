...
const Register = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
         <title>Rentdigicare | Register </title>
      </MetaTags>
                  ...
                  <div className="d-flex flex-column h-100">
                    ...
                    <div className="auth-content my-auto">
                      <div className="text-center">
                        ...
                        <p className="text-muted mt-2">Sign in to continue to Rentdigi Care</p>
                      </div>
                      <AvForm
                    ...
                    <div className="mt-4 mt-md-5 text-center">
                      <p className="mb-0"> {new Date().getFullYear()} © <i className="mdi mdi-heart text-danger"></i> Rentdigi Care</p>
                    </div>
                  </div>
                </div>
              </div>
